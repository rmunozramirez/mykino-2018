    ...
    <div class="row wrapper border-bottom white-bg">
      ...
      <div class="row">
         ...
         <div class="col-md-12" id="actors" role="tabpanel">
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-2 actor-list">
                <div class="card">
                  <a href="{{route('actors.show', $actor->slug)}}">
                  <img class="" src="{{URL::to('/images/' . $actor->image->image ) }}" alt="{{$element->name}}" >
                  <div class="card-body text-center">
                    <h4 class="card-title">{{$actor->name}}</h4>
                    <p class="card-text">Films: {{ count($actor->films) }}</p>
                  </div>
                </a>
                </div>
              </div>
