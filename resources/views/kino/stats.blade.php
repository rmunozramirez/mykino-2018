                                 ...
                                 <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td><a href="{{route('language.show', $element->language->slug)}}"><img height="50" src="{{$element->language->image ? URL::to('/images/' . $element->language->image->slug) : URL::to('/images/language.png')}}" alt="{{$element->language->name}}"  title="{{$element->language->name}}"></a></td>
                                          <td>
